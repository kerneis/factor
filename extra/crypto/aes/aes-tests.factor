...
[ t ] [ 0x01 11 nxtimes rcon = ] unit-test
...
{ { 142 77 161 188 } } [ { 219 19 83 69 } mix-column ]
unit-test
{ { 159 220 88 157 } } [ { 242 10 34 92 } mix-column ]
unit-test
{ { 213 213 215 214 } } [ { 212 212 212 213 } mix-column ]
unit-test
